...
public class StructureSaveTool {
    public static void executeSave(Level level, String fileName) {
        ...
        StructureTemplate template = StructureCapture.capture(level,
                StructureToolState.pos1, StructureToolState.pos2, StructureToolState.anchor,
                LinkToolState.nodes, LinkToolState.socketPoints, LinkToolState.ContactPoints
        );
